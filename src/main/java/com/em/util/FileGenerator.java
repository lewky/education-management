...
// ============================================================================
// CHANGE LOG
// em.1.0.0 : 2018-3-12, Lewis.Liu created
// ============================================================================
package com.em.util;
...
public final class FileGenerator {
    ...
    private static String genHeaderComment() {
        ...
        final SimpleDateFormat dateFomat = new SimpleDateFormat(GeneratorConsts.DEFAULT_DATE_FORMAT, Locale.US);
        ...
        return String.format(GeneratorConsts.CODE_HemDER_COMMENT, projectStartDate, calendar.get(Calendar.YEAR),
    ...
    private static <T> String getPackageName(final Class<T> clazz) {
        return StringUtils.substringBeforeLast(clazz.getName(), GeneratorConsts.SEPARATOR_DOT);
    }
